...
ajax_patterns = [
    ...
    re_path(r'^upload/screenshot/(?P<pk>\d+)', views.ajax_upload_screenshot_view, name='extensions-ajax-screenshot'),
...
urlpatterns = [
    ...
    re_path(r'^local/', TemplateView.as_view(template_name='extensions/local.html'), name='extensions-local'),
