...
class QueryExtensionsTest(BasicUserTestCase, TestCase):
    ...
    def test_grab_proper_extension_version(self):
        ...
        self.assertEqual(views.grab_proper_extension_version(extension, "3.17.1", True).version, 3)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.20.0", True).version, 4)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.2.0", True), None)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.4.0", True), None)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.20.1", True), None)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.4.0", False).version, 1)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.7.4.1", False).version, 1)
        ...
        self.assertEqual(views.grab_proper_extension_version(extension, "3.11.2", False).version, 1)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.13.4", False).version, 2)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.15.1", False).version, 2)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.15.2", False).version, 2)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.15.3", False).version, 2)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.16", False).version, 3)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.16.1", False).version, 3)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.16.2", False).version, 3)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.17.3", False).version, 3)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.18.3", False).version, 3)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.20.0", False).version, 4)
        self.assertEqual(views.grab_proper_extension_version(extension, "3.24.0", False).version, 4)
        self.assertEqual(views.grab_proper_extension_version(extension, "40.alpha", False).version, 6)
        self.assertEqual(views.grab_proper_extension_version(extension, "40.beta", False).version, 6)
        ...
        self.assertEqual(views.grab_proper_extension_version(extension, "44.2", False).version, 5)
        self.assertEqual(views.grab_proper_extension_version(extension, "129.rc", False).version, 5)
