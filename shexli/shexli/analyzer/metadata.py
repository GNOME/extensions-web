...
def parse_metadata(
    ...
    try:
        ...
        findings.append(
            RULES_BY_ID[R.EGO_M_002].make_finding(
...
def _check_uuid(
    ...
    if not isinstance(uuid, str) or not validate_uuid(uuid):
        findings.append(
            RULES_BY_ID[R.EGO_M_003].make_finding(
                (
...
def _check_shell_versions(
    ...
    if not isinstance(shell_versions, list) or not shell_versions:
        findings.append(
            RULES_BY_ID[R.EGO_M_004].make_finding(
                (
...
def _check_session_modes(
    ...
    if not isinstance(session_modes, list) or any(
        ...
        findings.append(
            RULES_BY_ID[R.EGO_M_006].make_finding(
        ...
        findings.append(
            RULES_BY_ID[R.EGO_M_005].make_finding(
                (
...
def _check_donations(
    ...
    if not isinstance(donations, dict):
        findings.append(
            RULES_BY_ID[R.EGO_M_007].make_finding(
                (
